...
def main():
    ...
    out_fp = f"{args.sample_batch}.csv"
    with open(out_fp, mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["sample_batch", "ref_batch", "inception_score", "fid", "sfid", "prec", "recall"])
        writer.writerow([args.sample_batch, args.ref_batch, is_score, fid, sfid, prec, recall])
    print(f"Results written to {out_fp}")
...
class Evaluator:
    ...
    def read_activations(self, npz_path: str) -> Tuple[np.ndarray, np.ndarray]:
        try:
            ...
            with open_npz_array(npz_path, "samples") as reader:
                return self.compute_activations(reader.read_batches(self.batch_size))
